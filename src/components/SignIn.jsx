...
export const SignIn = () => {
    ...
    return (
        <>
            ...
            <div class='flex'>
                <div class='border w-[50%] bg-[#605BFF] h-screen '>


                    <div class='m-10'>

                        <Logo width={'60px'} height={'60px'} fill={'white'} />
                    </div>


                    <div class='text-[50px] font-semibold h-[65%] flex justify-center items-center'>
                ...
                <div class="border w-[50%] bg-[#f8faff]">

                    <section class='w-[80%] ml-[2%]' >
                        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">

                            <div class='w-full p-2'>
                                <h2 class='text-[40px] font-semibold '>Sign In</h2>
                                <p>Sign in to your account</p>
                            </div>
                            <div class=' w-full flex gap-3 mb-2'>
                                ...
                                <button type="submit" class="w-[50%] border flex gap-2 items-center text-white bg-white hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                    ...
                                    <span class='text-[#858585]'>Sign in with Apple</span> </button>
                                ...
                                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                                    <form class="space-y-4 md:space-y-6" action="#">
                                        <div>
                                            ...
                                            <input type="email" name="email" id="email" class="sm rounded-lg  block w-full p-2.5   dark:placeholder-gray-400 dark:text-white" placeholder="name@company.com" required="" />
                                        </div>
                                        <div>
                                            <label for="password" class="block mb-1 text-sm font-medium">Password</label>
                                            <input type="password" name="password" id="password" placeholder="••••••••" class="text-gray-900 sm:text-sm rounded-lg block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 " required="" />
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <a href="#" class="text-sm font-medium text-[#346BD4] mb-2">Forgot password?</a>
                                        </div>
                                        <NavLink to={'/upload'} >
                                            <button type="submit" class="w-full text-white bg-[#346BD4] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" onClick={() => {
                                                toast.success('Login successful!');
                                            }}    >Sign in</button>
                                        </NavLink>
                                    </form>
                            ...
                            <p class="text-sm font-light text-gray-500 mt-[2%]">
                                Don’t have an account? <a href="#" class="font-medium text-[#346BD4]"> Register here</a>
                            </p>
                        </div>
                    </section>
